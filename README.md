...
This is a full featured bot for [Gitter.im](https://gitter.im).
...
> Join us in [Gitter.im](https://gitter.im) to discuss!
...
![](http://dcsan.github.io/gitterbot/images/anims/explain.gif)

### Points system
Allow your users to send points to each other to say `thanks @username`
![](http://dcsan.github.io/gitterbot/images/anims/points.gif)
...
# Credits
[@dcsan](https://github.com/dcsan) &mdash; [RIKAI Labs](mailto:dc@rikai.co).
